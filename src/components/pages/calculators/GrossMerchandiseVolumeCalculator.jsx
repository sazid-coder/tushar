...
const GrossMerchandiseVolumeCalculator = () => {
    ...
    const calculateGrowthRate = () => {
        ...
        const average = parseFloat(salesPrice);
        const activeS = parseFloat(soldItems);
        ...
        const growthRate = average * activeS ;
        setResult(growthRate.toFixed(2));
        localStorage.setItem('gmv', growthRate)
    };
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8 text-center">Gross Merchandise Volume (GMV)</h1>
            <div
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label htmlFor="currentRevenue"
                               className="block text-gray-700 dark:text-gray-300 text-lg font-medium mb-2">Sales Price of Goods</label>
                        <input
                            type="number"
                            id="currentRevenue"
                    ...
                    <div>
                        <label htmlFor="previousRevenue"
                               className="block text-gray-700 dark:text-gray-300 text-lg font-medium mb-2">Number of Items Sold</label>
                        <input
                            type="number"
                            id="previousRevenue"
                            className="w-full p-3 border border-gray-300 rounded-md bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                            value={soldItems}
                            onChange={(e) => setSoldItems(e.target.value)}
                ...
                {result !== null && (
                    <div
                        ...
                        <h3 className="text-2xl font-semibold text-blue-800 dark:text-blue-200 mb-3">Gross Merchandise Volume (GMV):</h3>
...
export default GrossMerchandiseVolumeCalculator;