...
const MonthlyRecurringRevenueCalculator = () => {
    ...
    const calculateGrowthRate = () => {
        ...
        localStorage.setItem('mrr', growthRate)
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8 text-center">Monthly Recurring Revenue</h1>
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 mb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label htmlFor="currentRevenue" className="block text-gray-700 dark:text-gray-300 text-lg font-medium mb-2">Average Revenue Per User (ARPU)</label>
                        <input
                            type="number"
                            id="currentRevenue"
                    ...
                    <div>
                        <label htmlFor="previousRevenue" className="block text-gray-700 dark:text-gray-300 text-lg font-medium mb-2">Total Active Subscribers</label>
                        <input
                            type="number"
                            id="previousRevenue"
                            className="w-full p-3 border border-gray-300 rounded-md bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                {result !== null && (
                    <div className="mt-6 p-6 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-700 text-center">
                        <h3 className="text-2xl font-semibold text-blue-800 dark:text-blue-200 mb-3">Monthly Recurring Revenue:</h3>
...
export default MonthlyRecurringRevenueCalculator;